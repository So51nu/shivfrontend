...
import {
  Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin,
   X, ChevronLeft, ChevronRight, Maximize2, Filter,
  Factory, Shield, Layers, Wrench, Settings, Building, Building2,
  Download, Share2, Heart, Menu, Home as HomeIcon, FileText, Sparkles, User,
} from 'lucide-react';
  ...
  display: block;
      ...
      <header style={{
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.4 }}
          variants={fadeInUp}
          style={{ position: "relative", zIndex: 2, color: "white", maxWidth: "800px", paddingTop: "90px", textAlign: "center", margin: "0 auto" }}
        >
          <p style={{ borderLeft: `4px solid ${COLORS.gold}`, paddingLeft: '15px', textTransform: 'uppercase', letterSpacing: '3px', fontSize: '14px', marginBottom: '20px', display: 'inline-block' }}>
            Our Work Gallery
          </p>
