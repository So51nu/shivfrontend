...
//                     ← Back to Main Website : https://shivshaktirealestateadvisory.com
//                   </Link>
//                 </div>
//               </motion.div>
//             </div>
  ...
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      * { box-sizing:border-box; }
      ...
      @media (max-width: 480px) {
        .topbar, .topbar-inner { height: 74px; }
        .brand { min-width: 0; gap: 10px; flex: 1; }
        .brand-icon { width: 66px; height: 66px; }
        .brand-title { font-size: 14px; line-height: 1.05; letter-spacing: 0.5px; }
        .brand-sub { font-size: 10px; }
        .login-badge {
          font-size: 11px;
          padding: 6px 16px;
